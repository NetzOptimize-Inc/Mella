...
public class MqttService extends Service implements MqttTraceHandler {
     ...
     *
     * @param clientHandle      identifies the MqttConnection to use
     * @param topic             a possibly wild carded topic name
     ...
     *
     * @param clientHandle      identifies the MqttConnection to use
     * @param topic             a list of possibly wild carded topic names
     ...
     *
     * @param clientHandle      identifies the MqttConnection to use
     * @param topicFilters      a list of possibly wild carded topic filters
     * @param qos               requested quality of service for each topic
     * @param invocationContext arbitrary data to be passed back to the application
     * @param activityToken     arbitrary identifier to be passed back to the Activity
    ...
    private void registerBroadcastReceivers() {
        if (networkConnectionMonitor == null) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                registerReceiver(networkConnectionMonitor, new IntentFilter(ConnectivityManager.CONNECTIVITY_ACTION), Context.RECEIVER_VISIBLE_TO_INSTANT_APPS);
            } else {
        ...
        if (backgroundDataPreferenceMonitor == null) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                registerReceiver(
                        ...
                        new IntentFilter(ConnectivityManager.ACTION_BACKGROUND_DATA_SETTING_CHANGED), Context.RECEIVER_VISIBLE_TO_INSTANT_APPS);
            } else {
                registerReceiver(
                        backgroundDataPreferenceMonitor,
