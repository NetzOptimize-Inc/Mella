...
public class EsptouchTaskParameter implements IEsptouchTaskParameter {
    ...
    private final long mIntervalGuideCodeMillisecond;
    private final long mIntervalDataCodeMillisecond;
    private final long mTimeoutGuideCodeMillisecond;
    private final long mTimeoutDataCodeMillisecond;
    private final int mTotalRepeatTime;
    private final int mEsptouchResultOneLen;
    private final int mEsptouchResultMacLen;
    private final int mEsptouchResultIpLen;
    private final int mEsptouchResultTotalLen;
    private final int mPortListening;
    private final int mTargetPort;
    private final int mWaitUdpReceivingMilliseond;
    private int mWaitUdpSendingMillisecond;
    private final int mThresholdSucBroadcastCount;
